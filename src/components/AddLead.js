...
import { setAddLeadModal, setManualLeadfetch } from "../redux/slices/crm";
...
const AddLead = () => {
  const { addLeadModal, manualLeadfetch } = useSelector((state) => state.crm);
  ...
  return (
    ...
    >
      ...
      >
        <div
          onClick={() => dispatch(setAddLeadModal(false))}
